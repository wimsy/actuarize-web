...
def fb_oauth_final(auth_vals):
  ...
  # Set inputs
  finalizeOAuthInputs.set_CallbackID(auth_vals['callback_id'])
...
def filter_friends(friend_list):
  for friend in friend_list:
    if type(friend['birthday_date']) == type(u'str'):
