...
class CreatePhotoPostWithURL(Choreography):
    ...
    """
    Create a new instance of the CreatePhotoPostWithURL Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Tumblr/CreatePhotoPostWithURL')
    ...
    def _make_result_set(self, result, path):
        return CreatePhotoPostWithURLResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreatePhotoPostWithURLChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the CreatePhotoPostWithURL
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class CreatePhotoPostWithURLInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the CreatePhotoPostWithURL choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class CreatePhotoPostWithURLResultSet(ResultSet):
        """
...
class CreatePhotoPostWithURLChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreatePhotoPostWithURLResultSet(response, path)
