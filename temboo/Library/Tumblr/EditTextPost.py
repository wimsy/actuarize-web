...
class EditTextPost(Choreography):
    ...
    """
    Create a new instance of the EditTextPost Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Tumblr/EditTextPost')
...
"""
A ResultSet with methods tailored to the values returned by the EditTextPost choreography.
