...
class EditQuotePost(Choreography):
    ...
    """
    Create a new instance of the EditQuotePost Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Tumblr/EditQuotePost')
...
"""
A ResultSet with methods tailored to the values returned by the EditQuotePost choreography.
