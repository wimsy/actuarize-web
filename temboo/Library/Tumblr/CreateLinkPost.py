...
class CreateLinkPost(Choreography):
    ...
    """
    Create a new instance of the CreateLinkPost Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Tumblr/CreateLinkPost')
...
"""
A ResultSet with methods tailored to the values returned by the CreateLinkPost choreography.
