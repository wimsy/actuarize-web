...
class QueryInputSet(InputSet):
        ...
        """
        Set the value of the IncludeEntities input for this choreography. ((optional, boolean) When set to either true or 1, each tweet will include a node called "entities". This node offers a variety of extra metadata about the tweet.)
        """
        ...
        """
        Set the value of the ResponseFormat input for this choreography. ((optional, string) Specify the format of the response from Twitter: json, or atom.  Default is set to atom.)
        """
