...
class GetUnsettledTransactionList(Choreography):
    ...
    """
    Create a new instance of the GetUnsettledTransactionList Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetUnsettledTransactionList choreography.
