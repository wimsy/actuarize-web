...
class CreateSubscriptionWithBankAccount(Choreography):

    """
    Create a new instance of the CreateSubscriptionWithBankAccount Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/AuthorizeNet/AutomatedRecurringBilling/CreateSubscriptionWithBankAccount')


    def new_input_set(self):
        return CreateSubscriptionWithBankAccountInputSet()

    def _make_result_set(self, result, path):
        return CreateSubscriptionWithBankAccountResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateSubscriptionWithBankAccountChoreographyExecution(session, exec_id, path)
...
"""
class CreateSubscriptionWithBankAccountInputSet(InputSet):
        """
        ...
        """
        Set the value of the AccountNumber input for this choreography. ((required, integer) The account number associated with the bank account payment.)
        """
        def set_AccountNumber(self, value):
            InputSet._set_input(self, 'AccountNumber', value)

        """
        Set the value of the AccountType input for this choreography. ((required, string) The account type to use for the bank account payment. Accepted values are: checking, businessChecking, and savings.)
        """
        ...
        """
        Set the value of the BankName input for this choreography. ((optional, string) The bank name associated with the bank account number.)
        """
        ...
        """
        Set the value of the ECheckType input for this choreography. ((required, string) The type of electronic check transaction used for the subscription. Acceptable values are: PPD or WEB.)
        """
        ...
        """
        Set the value of the NameOnAccount input for this choreography. ((required, string) The name on the bank account.)
        """
        ...
        """
        Set the value of the RoutingNumber input for this choreography. ((required, integer) The routing number associated with the bank account payment.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the CreateSubscriptionWithBankAccount choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class CreateSubscriptionWithBankAccountResultSet(ResultSet):
        """
...
class CreateSubscriptionWithBankAccountChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateSubscriptionWithBankAccountResultSet(response, path)
