...
class GetSubscriptionStatus(Choreography):
    ...
    """
    Create a new instance of the GetSubscriptionStatus Choreography. A TembooSession object, containing a valid
...
class GetSubscriptionStatusInputSet(InputSet):
        ...
        """
        Set the value of the SubscriptionId input for this choreography. ((required, integer) The id of the subscription that you want to retrieve the status for.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetSubscriptionStatus choreography.
