...
class UpdateSubscription(Choreography):
    ...
    """
    Create a new instance of the UpdateSubscription Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/AuthorizeNet/AutomatedRecurringBilling/UpdateSubscription')
...
class UpdateSubscriptionInputSet(InputSet):
        """
        Set the value of the RequestXML input for this choreography. ((optional, xml) Use this input to bybass single element inputs and submit your own XML for the request. See documentation for information on the correct schema.)
        """
        ...
        """
        Set the value of the AccountNumber input for this choreography. ((optional, integer) The account number when a banking account payment is specified.)
        """
        def set_AccountNumber(self, value):
            InputSet._set_input(self, 'AccountNumber', value)

        """
        Set the value of the AccountType input for this choreography. ((optional, string) The account type to use when a banking account payment is specified. Accepted values are: checking, businessChecking, and savings.)
        """
        def set_AccountType(self, value):
            InputSet._set_input(self, 'AccountType', value)

        """
        Set the value of the Amount input for this choreography. ((optional, decimal) The amount to bill the customer for each recurring payment.)
        """
        def set_Amount(self, value):
            InputSet._set_input(self, 'Amount', value)

        """
        Set the value of the BankName input for this choreography. ((optional, string) The bank name associated with the bank account number specified for a bank account payment.)
        """
        ...
        """
        Set the value of the BillingFirstName input for this choreography. ((optional, string) The first name associated with the billing address.)
        """
        def set_BillingFirstName(self, value):
            InputSet._set_input(self, 'BillingFirstName', value)

        """
        Set the value of the BillingLastName input for this choreography. ((optional, string) The last name associated with the billing address.)
        """
        ...
        """
        Set the value of the CardCode input for this choreography. ((optional, integer) The 3 digit security code of the credit card.)
        """
        def set_CardCode(self, value):
            InputSet._set_input(self, 'CardCode', value)

        """
        Set the value of the CardNumber input for this choreography. ((optional, integer) The credit card number for the recurring payment.)
        """
        ...
        """
        Set the value of the ECheckType input for this choreography. ((optional, string) The type of electronic check transaction used for the subscription. Acceptable values are: PPD or WEB.)
        """
        ...
        """
        Set the value of the ExpirationDate input for this choreography. ((optional, date) The 4 digit expiration date of the credit card. Formatted like MM/YY.)
        """
        ...
        """
        Set the value of the NameOnAccount input for this choreography. ((optional, string) The name on the bank account.)
        """
        ...
        """
        Set the value of the RoutingNumber input for this choreography. ((optional, integer) The routing number associated with the bank account payment.)
        """
        ...
        """
        Set the value of the StartDate input for this choreography. ((optional, date) The date that the subscription and billing begin. Formatted like YYYY-MM-DD.)
        """
        def set_StartDate(self, value):
            InputSet._set_input(self, 'StartDate', value)

        """
        Set the value of the SubscriptionId input for this choreography. ((required, integer) The id of the subscription you want to update.)
        """
        ...
        """
        Set the value of the TotalOccurrences input for this choreography. ((optional, integer) Number of billing occurrences or payments for the subscription.)
        """
        ...
        """
        Set the value of the TrialOccurrences input for this choreography. ((optional, integer) Number of billing occurrences or payments in the trial period.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the UpdateSubscription choreography.
