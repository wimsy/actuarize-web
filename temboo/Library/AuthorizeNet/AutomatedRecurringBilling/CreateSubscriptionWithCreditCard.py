...
class CreateSubscriptionWithCreditCard(Choreography):

    """
    Create a new instance of the CreateSubscriptionWithCreditCard Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/AuthorizeNet/AutomatedRecurringBilling/CreateSubscriptionWithCreditCard')


    def new_input_set(self):
        return CreateSubscriptionWithCreditCardInputSet()

    def _make_result_set(self, result, path):
        return CreateSubscriptionWithCreditCardResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateSubscriptionWithCreditCardChoreographyExecution(session, exec_id, path)
...
"""
class CreateSubscriptionWithCreditCardInputSet(InputSet):
        """
        ...
        """
        Set the value of the CardNumber input for this choreography. ((required, integer) The credit card number for the recurring payment.)
        """
        ...
        """
        Set the value of the ExpirationDate input for this choreography. ((required, date) The 4 digit expiration date of the credit card. Formatted like MM/YY.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the CreateSubscriptionWithCreditCard choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class CreateSubscriptionWithCreditCardResultSet(ResultSet):
        """
...
class CreateSubscriptionWithCreditCardChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateSubscriptionWithCreditCardResultSet(response, path)
