...
class DeleteWordList(Choreography):
    ...
    """
    Create a new instance of the DeleteWordList Choreography. A TembooSession object, containing a valid
...
class DeleteWordListInputSet(InputSet):
        ...
        """
        Set the value of the WordList input for this choreography. ((required, string) The perma-link of the WordLIst to delete.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the DeleteWordList choreography.
