...
class RandomWord(Choreography):
    ...
    """
    Create a new instance of the RandomWord Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the RandomWord choreography.
