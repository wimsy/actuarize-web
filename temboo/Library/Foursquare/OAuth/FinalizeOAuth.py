...
#
# FinalizeOAuth
# Completes the OAuth process by retrieving a Foursquare access token for a user. 
#
# Python version 2.6
#
###############################################################################
...
class FinalizeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Foursquare/OAuth/FinalizeOAuth')
...
class FinalizeOAuthInputSet(InputSet):
        ...
        """
        Set the value of the ClientSecret input for this choreography. ((required, string) The Client Secret provided by Foursquare after registering your application.)
        """
