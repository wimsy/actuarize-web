...
class Like(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Foursquare/Venues/Like')
...
class LikeInputSet(InputSet):
        ...
        """
        Set the value of the Set input for this choreography. ((optional, boolean) Set to 1 (the default) to like this checkin. Set to 0 to undo a previous like.)
        """
        def set_Set(self, value):
            InputSet._set_input(self, 'Set', value)

        """
        Set the value of the VenueID input for this choreography. ((required, string) The ID of the venue to like or unlike.)
        """
