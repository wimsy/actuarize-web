...
class Reply(Choreography):
    ...
    """
    Create a new instance of the Reply Choreography. A TembooSession object, containing a valid
...
class ReplyInputSet(InputSet):
        ...
        """
        Set the value of the ContentID input for this choreography. ((optional, string) An ID for the reply to be used in a native link. Can be up to 50 characters. The URL input must also be specified when using this parameter.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the Reply choreography.
