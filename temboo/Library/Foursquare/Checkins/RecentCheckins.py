...
class RecentCheckinsInputSet(InputSet):
        """
        Set the value of the AfterTimeStamp input for this choreography. ((optional, integer) Seconds after which to look for check-ins, e.g. for looking for new check-ins since the last fetch.)
        """
