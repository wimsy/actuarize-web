...
class CheckinDetailsInputSet(InputSet):
        """
        Set the value of the CheckinID input for this choreography. ((required, string) The ID of the check-in to retrieve additional information for.)
        """
        ...
        """
        Set the value of the Signature input for this choreography. ((optional, string) When check-ins are sent to public feeds such as Twitter, foursquare appends a signature to them (s=XXXXXX). The same value can be used here.)
        """
