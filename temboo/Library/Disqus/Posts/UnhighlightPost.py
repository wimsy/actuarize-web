...
class UnhighlightPost(Choreography):
    ...
    """
    Create a new instance of the UnhighlightPost Choreography. A TembooSession object, containing a valid
...
class UnhighlightPostInputSet(InputSet):
        ...
        """
        Set the value of the PostID input for this choreography. ((required, integer) The post ID which is to be unhighlighted.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the UnhighlightPost choreography.
