...
class ReportPost(Choreography):
    ...
    """
    Create a new instance of the ReportPost Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Disqus/Posts/ReportPost')
...
class ReportPostInputSet(InputSet):
        ...
        """
        Set the value of the PostID input for this choreography. ((required, integer) The post ID which is to be reported (flagged).)
        """
...
"""
A ResultSet with methods tailored to the values returned by the ReportPost choreography.
