...
class BestSellerListByDateInputSet(InputSet):
        ...
        """
        Set the value of the Date input for this choreography. ((required, date) The best-seller list publication date. Can be an epoch timestamp in milliseconds or in YYYY-MM-DD format.)
        """
        def set_Date(self, value):
            InputSet._set_input(self, 'Date', value)

        """
        Set the value of the ListName input for this choreography. ((required, string) The Times best-seller list to retrieve (i.e. e-book-fiction or hardcover-fiction))
        """
