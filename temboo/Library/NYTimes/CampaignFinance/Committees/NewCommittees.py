...
class NewCommittees(Choreography):
    ...
    """
    Create a new instance of the NewCommittees Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the NewCommittees choreography.
