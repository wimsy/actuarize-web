...
class CommitteeFilings(Choreography):
    ...
    """
    Create a new instance of the CommitteeFilings Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the CommitteeFilings choreography.
