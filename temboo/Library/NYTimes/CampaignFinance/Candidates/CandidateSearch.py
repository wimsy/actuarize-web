...
class CandidateSearch(Choreography):
    ...
    """
    Create a new instance of the CandidateSearch Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/NYTimes/CampaignFinance/Candidates/CandidateSearch')
    ...
    def _make_result_set(self, result, path):
        return CandidateSearchResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CandidateSearchChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the CandidateSearch
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class CandidateSearchInputSet(InputSet):
        """
        ...
        """
        Set the value of the LastName input for this choreography. ((required, string) Enter the last name (or partial last name) of a Congressional or Presidential office candidate.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the CandidateSearch choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class CandidateSearchResultSet(ResultSet):
        """
...
class CandidateSearchChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CandidateSearchResultSet(response, path)
