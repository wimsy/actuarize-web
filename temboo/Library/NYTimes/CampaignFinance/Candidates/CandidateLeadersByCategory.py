...
class CandidateLeadersByCategory(Choreography):
    ...
    """
    Create a new instance of the CandidateLeadersByCategory Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/NYTimes/CampaignFinance/Candidates/CandidateLeadersByCategory')
...
class CandidateLeadersByCategoryInputSet(InputSet):
        ...
        """
        Set the value of the Category input for this choreography. ((required, string) Specify thecategory to be retrieved. Example: contribution-total, returns the total amount of financial contributions received by this candidate's campaign.  See Description for more info.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the CandidateLeadersByCategory choreography.
