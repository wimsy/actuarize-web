...
class ListingsCounts(Choreography):
    ...
    """
    Create a new instance of the ListingsCounts Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/NYTimes/RealEstate/ListingsCounts')
    ...
    def _make_result_set(self, result, path):
        return ListingsCountsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListingsCountsChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the ListingsCounts
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class ListingsCountsInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the ListingsCounts choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class ListingsCountsResultSet(ResultSet):
        """
...
class ListingsCountsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListingsCountsResultSet(response, path)
