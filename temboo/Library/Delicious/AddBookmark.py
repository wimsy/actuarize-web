...
class AddBookmarkInputSet(InputSet):
        """
        Set the value of the Description input for this choreography. ((required, string) A description for the link to post.)
        """
        ...
        """
        Set the value of the URL input for this choreography. ((required, string) The URL for the link to post.)
        """
