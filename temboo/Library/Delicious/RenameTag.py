...
class RenameTagInputSet(InputSet):
        """
        Set the value of the NewTag input for this choreography. ((required, string) The new tag name.)
        """
        def set_NewTag(self, value):
            InputSet._set_input(self, 'NewTag', value)

        """
        Set the value of the OldTag input for this choreography. ((required, string) The existing tag to rename.)
        """
