...
class SendNotification(Choreography):
    ...
    """
    Create a new instance of the SendNotification Choreography. A TembooSession object, containing a valid
...
class SendNotificationInputSet(InputSet):
        """
        Set the value of the Notifcation input for this choreography. ((required, json) A JSON string containing the push notification data. See documentation for syntax examples.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the SendNotification choreography.
