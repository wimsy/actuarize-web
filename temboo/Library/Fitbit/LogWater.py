...
class LogWaterInputSet(InputSet):
        ...
        """
        Set the value of the AccessokenSecret input for this choreography. ((required, string) The Access Token Secret retrieved during the OAuth process.)
        """
        def set_AccessokenSecret(self, value):
            InputSet._set_input(self, 'AccessokenSecret', value)

        """
        Set the value of the Amount input for this choreography. ((required, decimal) The amount of water consumed. Corresponds to the Unit input.)
        """
        ...
        """
        Set the value of the Unit input for this choreography. ((required, string) Unit of measurement for the water entry. Valid values: 'ml', 'fl oz', or 'cup'.)
        """
