...
class SearchFoods(Choreography):
    ...
    """
    Create a new instance of the SearchFoods Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/SearchFoods')
...
class SearchFoodsInputSet(InputSet):
        ...
        """
        Set the value of the Query input for this choreography. ((required, string) The search query (i.e. artichoke).)
        """
...
"""
A ResultSet with methods tailored to the values returned by the SearchFoods choreography.
