...
class GetFrequentFoods(Choreography):
    ...
    """
    Create a new instance of the GetFrequentFoods Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Fitbit/GetFrequentFoods')
    ...
    def _make_result_set(self, result, path):
        return GetFrequentFoodsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetFrequentFoodsChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the GetFrequentFoods
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class GetFrequentFoodsInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetFrequentFoods choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class GetFrequentFoodsResultSet(ResultSet):
        """
...
class GetFrequentFoodsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetFrequentFoodsResultSet(response, path)
