...
class RestoreFileToRevisionInputSet(InputSet):
        ...
        """
        Set the value of the Revision input for this choreography. ((required, string) The revision of the file to restore. The revision ID can be retrieved by running the GetFileRevision Choreo.)
        """
