...
class UpdateContactInputSet(InputSet):
        """
        Set the value of the UpdatedContactXML input for this choreography. ((required, xml) This input should be the updated XML returned from the ObtainContactInformation Choreo.)
        """
        ...
        """
        Set the value of the ContactId input for this choreography. ((required, integer) The id for the contact you want to update.)
        """
        def set_ContactId(self, value):
            InputSet._set_input(self, 'ContactId', value)

        """
        Set the value of the ListId input for this choreography. ((required, integer) The ID for the list that you want to update)
        """
        def set_ListId(self, value):
            InputSet._set_input(self, 'ListId', value)

        """
        Set the value of the Password input for this choreography. ((required, password) Your Constant Contact password.)
        """
        def set_Password(self, value):
            InputSet._set_input(self, 'Password', value)

        """
        Set the value of the UserName input for this choreography. ((required, string) You Constant Contact username.)
        """
...
class UpdateContactResultSet(ResultSet):
        """
        Retrieve the value for the "Response" output from this choreography execution. ((xml) The response from Constant Contact. Note that a successful update returns no content.)
        """
