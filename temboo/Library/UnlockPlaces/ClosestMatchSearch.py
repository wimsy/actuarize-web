...
class ClosestMatchSearch(Choreography):
    ...
    """
    Create a new instance of the ClosestMatchSearch Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the ClosestMatchSearch choreography.
