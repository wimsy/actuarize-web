...
class PostCodeSearch(Choreography):
    ...
    """
    Create a new instance of the PostCodeSearch Choreography. A TembooSession object, containing a valid
...
class PostCodeSearchInputSet(InputSet):
        ...
        """
        Set the value of the PostCode input for this choreography. ((required, string) A UK postal code to use for the search.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the PostCodeSearch choreography.
