...
class ConvertXMLToJSON(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/DevShortcuts/DataConversions/ConvertXMLToJSON')
...
class ConvertXMLToJSONInputSet(InputSet):
        """
        Set the value of the XML input for this choreography. ((required, xml) The XML file that you want to convert to JSON format.)
        """
