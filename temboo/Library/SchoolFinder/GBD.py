...
class GBD(Choreography):
    ...
    """
    Create a new instance of the GBD Choreography. A TembooSession object, containing a valid
...
class GBDInputSet(InputSet):
        ...
        """
        Set the value of the NCES input for this choreography. ((conditional, string) The nces id of the school.)
        """
        ...
        """
        Set the value of the SchoolID input for this choreography. ((conditional, string) The id of the school.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GBD choreography.
