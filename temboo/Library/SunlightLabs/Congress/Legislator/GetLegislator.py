...
class GetLegislator(Choreography):
    ...
    """
    Create a new instance of the GetLegislator Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/SunlightLabs/Congress/Legislator/GetLegislator')
...
class GetLegislatorInputSet(InputSet):
        ...
        """
        Set the value of the LastName input for this choreography. ((conditional, string) The last name of the legislator to return.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetLegislator choreography.
