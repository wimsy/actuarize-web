...
class ListSharedSpreadsheets(Choreography):
    ...
    """
    Create a new instance of the ListSharedSpreadsheets Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Zoho/Sheet/ListSharedSpreadsheets')
...
"""
A ResultSet with methods tailored to the values returned by the ListSharedSpreadsheets choreography.
