...
class ListTrashedSpreadsheets(Choreography):
    ...
    """
    Create a new instance of the ListTrashedSpreadsheets Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the ListTrashedSpreadsheets choreography.
