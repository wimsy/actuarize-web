...
class ListAllSpreadsheets(Choreography):
    ...
    """
    Create a new instance of the ListAllSpreadsheets Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Zoho/Sheet/ListAllSpreadsheets')
    ...
    def _make_result_set(self, result, path):
        return ListAllSpreadsheetsResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return ListAllSpreadsheetsChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the ListAllSpreadsheets
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class ListAllSpreadsheetsInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the ListAllSpreadsheets choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class ListAllSpreadsheetsResultSet(ResultSet):
        """
...
class ListAllSpreadsheetsChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return ListAllSpreadsheetsResultSet(response, path)
