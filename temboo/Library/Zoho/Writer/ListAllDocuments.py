...
class ListAllDocuments(Choreography):
    ...
    """
    Create a new instance of the ListAllDocuments Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the ListAllDocuments choreography.
