...
class ListTrashedDocuments(Choreography):
    ...
    """
    Create a new instance of the ListTrashedDocuments Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Zoho/Writer/ListTrashedDocuments')
...
"""
A ResultSet with methods tailored to the values returned by the ListTrashedDocuments choreography.
