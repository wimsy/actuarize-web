...
class ListPublicDocuments(Choreography):
    ...
    """
    Create a new instance of the ListPublicDocuments Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the ListPublicDocuments choreography.
