...
class GetSearchRecordsInputSet(InputSet):
        ...
        """
        Set the value of the SearchExpression input for this choreography. ((required, string) Specify an expression to use in your search (i.e. =, <>, contains, starts with, ends with, doesn't contain, <, >, <=, =>))
        """
