...
class LoginInputSet(InputSet):
        ...
        """
        Set the value of the Email input for this choreography. ((required, string) Your AdMob username.)
        """
        def set_Email(self, value):
            InputSet._set_input(self, 'Email', value)

        """
        Set the value of the Password input for this choreography. ((required, password) Your Admob password.)
        """
