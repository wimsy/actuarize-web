...
class DeleteEntry(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/RunKeeper/GeneralMeasurements/DeleteEntry')
...
class DeleteEntryInputSet(InputSet):
        ...
        """
        Set the value of the EntryID input for this choreography. ((required, string) This can be the individual id of the body measurement entry, or you can pass the full uri for the entry as returned from the RetrieveEntries Choreo (i.e. /generalMeasurements/-12985593-1351036800000).)
        """
