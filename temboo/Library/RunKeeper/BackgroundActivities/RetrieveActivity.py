...
class RetrieveActivity(Choreography):
    ...
    """
    Create a new instance of the RetrieveActivity Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/RunKeeper/BackgroundActivities/RetrieveActivity')
...
class RetrieveActivityInputSet(InputSet):
        ...
        """
        Set the value of the ActivityID input for this choreography. ((required, string) This can be the individual id of the activity, or you can pass the full uri for the activity as returned from the RetrieveActivities Choreo (i.e. /backgroundActivities/-12985593-1347998400000).)
        """
...
"""
A ResultSet with methods tailored to the values returned by the RetrieveActivity choreography.
