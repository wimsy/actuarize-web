...
class RecordActivity(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/RunKeeper/FitnessActivities/RecordActivity')
...
class RecordActivityResultSet(ResultSet):
        """
        Retrieve the value for the "Response" output from this choreography execution. ((boolean) Contains the string "true" when an activity is created successfully.)
        """
