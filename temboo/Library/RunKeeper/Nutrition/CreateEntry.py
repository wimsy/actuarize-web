...
class CreateEntry(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/RunKeeper/Nutrition/CreateEntry')
...
class CreateEntryInputSet(InputSet):
        """
        Set the value of the Entry input for this choreography. ((required, json) A JSON string containing the key/value pairs for the entry to create. See documentation for formatting examples.)
        """
