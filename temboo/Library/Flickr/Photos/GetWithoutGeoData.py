...
class GetWithoutGeoData(Choreography):
    ...
    """
    Create a new instance of the GetWithoutGeoData Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Flickr/Photos/GetWithoutGeoData')
    ...
    def _make_result_set(self, result, path):
        return GetWithoutGeoDataResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetWithoutGeoDataChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the GetWithoutGeoData
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class GetWithoutGeoDataInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetWithoutGeoData choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class GetWithoutGeoDataResultSet(ResultSet):
        """
...
class GetWithoutGeoDataChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetWithoutGeoDataResultSet(response, path)
