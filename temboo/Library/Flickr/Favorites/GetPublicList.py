...
class GetPublicList(Choreography):
    ...
    """
    Create a new instance of the GetPublicList Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Flickr/Favorites/GetPublicList')
    ...
    def _make_result_set(self, result, path):
        return GetPublicListResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetPublicListChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the GetPublicList
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class GetPublicListInputSet(InputSet):
        """
        ...
        """
        Set the value of the UserId input for this choreography. ((required, string) The user to fetch the favorites list for.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetPublicList choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class GetPublicListResultSet(ResultSet):
        """
...
class GetPublicListChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetPublicListResultSet(response, path)
