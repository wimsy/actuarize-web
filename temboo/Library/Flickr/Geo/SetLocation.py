...
class SetLocation(Choreography):
    ...
    """
    Create a new instance of the SetLocation Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Flickr/Geo/SetLocation')
    ...
    def _make_result_set(self, result, path):
        return SetLocationResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return SetLocationChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the SetLocation
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class SetLocationInputSet(InputSet):
        """
        ...
        """
        Set the value of the Context input for this choreography. ((optional, string) A numeric value representing the photo's location beyond latitude and longitude. For example, you can indicate that a photo was taken "indoors" or "outdoors". Set to 1 for indoors or 2 for outdoors.)
        """
        ...
        """
        Set the value of the PhotoID input for this choreography. ((required, integer) The id of the photo to set location data for.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the SetLocation choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class SetLocationResultSet(ResultSet):
        """
...
class SetLocationChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return SetLocationResultSet(response, path)
