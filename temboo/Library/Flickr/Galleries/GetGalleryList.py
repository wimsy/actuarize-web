...
class GetGalleryListInputSet(InputSet):
        ...
        """
        Set the value of the GalleriesPerPage input for this choreography. ((optional, integer) Specify the number of galleries that are to be returned per page.  If null, defaults to 100 galleries returned.  Maximum is 500.)
        """
        ...
        """
        Set the value of the UserID input for this choreography. ((optional, string) Provide the NSID for the user whose gallery list(s) are to be retreived.)
        """
