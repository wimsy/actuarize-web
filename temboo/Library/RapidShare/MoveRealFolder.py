...
class MoveRealFolderInputSet(InputSet):
        """
        Set the value of the FolderId input for this choreography. ((required, integer) The id of the folder(s) to be moved. Can be a commas separated list of ids.)
        """
        ...
        """
        Set the value of the NewParent input for this choreography. ((required, integer) Enter the ID of new parent folder)
        """
