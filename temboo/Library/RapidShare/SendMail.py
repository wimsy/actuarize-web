...
class SendMailInputSet(InputSet):
        """
        Set the value of the Comment input for this choreography. ((required, string) A comment that you want to send with the email)
        """
        def set_Comment(self, value):
            InputSet._set_input(self, 'Comment', value)

        """
        Set the value of the Email1 input for this choreography. ((required, string) The first email address to send to)
        """
        ...
        """
        Set the value of the FileID1 input for this choreography. ((required, integer) The id for the file to inform the email recipient about)
        """
        def set_FileID1(self, value):
            InputSet._set_input(self, 'FileID1', value)

        """
        Set the value of the FileName1 input for this choreography. ((required, string) The name of the file to inform the email recipient about)
        """
        ...
        """
        Set the value of the Name input for this choreography. ((required, string) The senders name)
        """
        ...
        """
        Set the value of the ReplyEmail input for this choreography. ((required, string) The sender reply email address)
        """
        def set_ReplyEmail(self, value):
            InputSet._set_input(self, 'ReplyEmail', value)

        """
        Set the value of the Subject input for this choreography. ((required, string) The subject line for the email)
        """
