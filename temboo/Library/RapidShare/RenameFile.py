...
class RenameFileInputSet(InputSet):
        """
        Set the value of the FileId input for this choreography. ((required, integer) The ID of the file to be renamed. Can be a commas separated list of ids.)
        """
        ...
        """
        Set the value of the NewFileName input for this choreography. ((required, string) The new file name.)
        """
