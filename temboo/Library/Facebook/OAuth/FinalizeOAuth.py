...
class FinalizeOAuthInputSet(InputSet):
        ...
        """
        Set the value of the AppSecret input for this choreography. ((required, string) The App Secret provided by Facebook (AKA the Client Secret).)
        """
        ...
        """
        Set the value of the LongLivedToken input for this choreography. ((optional, boolean) Set to 1 to automatically exchange the short-lived access token for a long-lived access token. Defaults to 0 (false).)
        """
...
class FinalizeOAuthResultSet(ResultSet):
        ...
        """
        Retrieve the value for the "ErrorMessage" output from this choreography execution. ((string) If an error occurs during the redirect process, this output variable will contain the error message generated by Foursquare.)
        """
        def get_ErrorMessage(self):
            return self._output.get('ErrorMessage', None)
        """
        Retrieve the value for the "Expires" output from this choreography execution. ((integer) The expiration time of the access_token retrieved.)
        """
