...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Facebook/OAuth/InitializeOAuth')
...
class InitializeOAuthInputSet(InputSet):
        ...
        """
        Set the value of the AppID input for this choreography. ((required, string) The App ID provided by Facebook (AKA the Client ID).)
        """
        ...
        """
        Set the value of the Scope input for this choreography. ((optional, string) A comma-separated list of permissions to request access for (i.e. user_birthday,read_stream).)
        """
...
class InitializeOAuthResultSet(ResultSet):
        """
        Retrieve the value for the "AuthorizationURL" output from this choreography execution. ((string) The authorization URL to send your user to in order for them to grant access to your application.)
        """
