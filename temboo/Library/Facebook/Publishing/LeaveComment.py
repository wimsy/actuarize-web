...
class LeaveComment(Choreography):
    ...
    """
    Create a new instance of the LeaveComment Choreography. A TembooSession object, containing a valid
...
class LeaveCommentInputSet(InputSet):
        ...
        """
        Set the value of the ObjectID input for this choreography. ((required, string) The id of a graph api object to comment on.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the LeaveComment choreography.
