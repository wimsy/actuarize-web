...
class CreateCheckinInputSet(InputSet):
        ...
        """
        Set the value of the Latitude input for this choreography. ((conditional, decimal) The latitude coordinate of the Checkin location.)
        """
        def set_Latitude(self, value):
            InputSet._set_input(self, 'Latitude', value)

        """
        Set the value of the Longitude input for this choreography. ((conditional, decimal) The longitude coordinate of the Checkin location.)
        """
        ...
        """
        Set the value of the PlaceID input for this choreography. ((conditional, string) The ID of the place associated with your Checkin.)
        """
        def set_PlaceID(self, value):
            InputSet._set_input(self, 'PlaceID', value)

        """
        Set the value of the ProfileID input for this choreography. ((optional, string) The id of the profile to create a checkin for. Defaults to "me" indicating the authenticated user.)
        """
