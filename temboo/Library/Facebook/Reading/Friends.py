...
class Friends(Choreography):
    ...
    """
    Create a new instance of the Friends Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Facebook/Reading/Friends')
...
class FriendsInputSet(InputSet):
        ...
        """
        Set the value of the ProfileID input for this choreography. ((optional, string) The id of the profile to retrieve a friends list for. Defaults to "me" indicating the authenticated user.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the Friends choreography.
