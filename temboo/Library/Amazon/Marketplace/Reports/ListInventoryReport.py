...
class ListInventoryReport(Choreography):
    ...
    """
    Create a new instance of the ListInventoryReport Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the ListInventoryReport choreography.
