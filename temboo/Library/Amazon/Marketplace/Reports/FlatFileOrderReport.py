...
class FlatFileOrderReport(Choreography):
    ...
    """
    Create a new instance of the FlatFileOrderReport Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Amazon/Marketplace/Reports/FlatFileOrderReport')
...
"""
A ResultSet with methods tailored to the values returned by the FlatFileOrderReport choreography.
