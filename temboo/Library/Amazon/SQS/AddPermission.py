...
class AddPermission(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Amazon/SQS/AddPermission')
...
class AddPermissionInputSet(InputSet):
        ...
        """
        Set the value of the AWSAccountId1 input for this choreography. ((required, integer) The AWS account number of the user that will be granted access to a specified action. Enter account number omitting any dashes.)
        """
        def set_AWSAccountId1(self, value):
            InputSet._set_input(self, 'AWSAccountId1', value)
        ...
        """
        Set the value of the ActionName input for this choreography. ((required, string) The action to allow for a specified user. Valid values: SendMessage, ReceiveMessage, DeleteMessage,ChangeMessageVisibility, GetQueueAttributes.)
        """
        def set_ActionName(self, value):
            InputSet._set_input(self, 'ActionName', value)

        """
        Set the value of the Label input for this choreography. ((required, string) The unique identifier for the new permission that is being set.)
        """
        def set_Label(self, value):
            InputSet._set_input(self, 'Label', value)

        """
        Set the value of the QueueName input for this choreography. ((required, string) The name of the queue that you're granting access to.)
        """
