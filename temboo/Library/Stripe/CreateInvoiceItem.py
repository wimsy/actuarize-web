...
class CreateInvoiceItemInputSet(InputSet):
        """
        Set the value of the APISecretKey input for this choreography. ((required, string) The secret API Key providied by Stripe)
        """
        def set_APISecretKey(self, value):
            InputSet._set_input(self, 'APISecretKey', value)

        """
        Set the value of the Amount input for this choreography. ((required, integer) The amount in cents of the charge to be included in the customer's next invoice)
        """
        ...
        """
        Set the value of the CustomerId input for this choreography. ((required, string) The unique identifier of the customer you want to create an invoice item for)
        """
