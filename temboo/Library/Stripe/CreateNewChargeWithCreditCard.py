...
class CreateNewChargeWithCreditCard(Choreography):
    ...
    """
    Create a new instance of the CreateNewChargeWithCreditCard Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Stripe/CreateNewChargeWithCreditCard')
    ...
    def _make_result_set(self, result, path):
        return CreateNewChargeWithCreditCardResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return CreateNewChargeWithCreditCardChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the CreateNewChargeWithCreditCard
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class CreateNewChargeWithCreditCardInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the CreateNewChargeWithCreditCard choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class CreateNewChargeWithCreditCardResultSet(ResultSet):
        """
...
class CreateNewChargeWithCreditCardChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return CreateNewChargeWithCreditCardResultSet(response, path)
