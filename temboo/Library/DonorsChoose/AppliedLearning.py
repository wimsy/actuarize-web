...
class AppliedLearning(Choreography):
    ...
    """
    Create a new instance of the AppliedLearning Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/DonorsChoose/AppliedLearning')
    ...
    def _make_result_set(self, result, path):
        return AppliedLearningResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return AppliedLearningChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the AppliedLearning
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class AppliedLearningInputSet(InputSet):
        """
        Set the value of the APIKey input for this choreography. ((optional, string) The APIKey provided by DonorsChoose.org. Defaults to the test  APIKey 'DONORSCHOOSE'.)
        """
        ...
        """
        Set the value of the Subject input for this choreography. ((optional, string) Enter a sub-category of Applied Learning. When left empty, all Applied Learning projects are returned.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the AppliedLearning choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class AppliedLearningResultSet(ResultSet):
        """
...
class AppliedLearningChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return AppliedLearningResultSet(response, path)
