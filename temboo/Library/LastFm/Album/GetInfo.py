...
class GetInfoInputSet(InputSet):
        ...
        """
        Set the value of the Username input for this choreography. ((optional, string) The username for the context of the request. If supplied, the user's playcount for this album is included in the response.)
        """
