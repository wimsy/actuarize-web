...
class AddTags(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/LastFm/Album/AddTags')
...
class AddTagsInputSet(InputSet):
        ...
        """
        Set the value of the Tags input for this choreography. ((string) A comma delimited list of user supplied tags to apply to this album. Accepts a maximum of 10 tags.)
        """
