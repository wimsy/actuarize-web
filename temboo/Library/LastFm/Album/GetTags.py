...
class GetTags(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/LastFm/Album/GetTags')
...
class GetTagsInputSet(InputSet):
        ...
        """
        Set the value of the User input for this choreography. ((required, string) The last.fm username to lookup.)
        """
