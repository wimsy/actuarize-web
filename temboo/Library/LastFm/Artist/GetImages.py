...
class GetImages(Choreography):
    ...
    """
    Create a new instance of the GetImages Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/LastFm/Artist/GetImages')
...
class GetImagesInputSet(InputSet):
        ...
        """
        Set the value of the Order input for this choreography. ((optional, string) Sort ordering can be either 'popularity' (default) or 'dateadded'.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetImages choreography.
