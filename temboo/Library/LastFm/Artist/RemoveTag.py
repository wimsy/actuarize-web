...
class RemoveTag(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/LastFm/Artist/RemoveTag')
...
class RemoveTagInputSet(InputSet):
        ...
        """
        Set the value of the Tag input for this choreography. ((string) A single user tag to remove from this artist.)
        """
