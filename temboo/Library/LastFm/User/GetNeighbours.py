...
class GetNeighbours(Choreography):
    ...
    """
    Create a new instance of the GetNeighbours Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/LastFm/User/GetNeighbours')
...
class GetNeighboursInputSet(InputSet):
        ...
        """
        Set the value of the User input for this choreography. ((string) The last.fm username to fetch the neighbours of.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetNeighbours choreography.
