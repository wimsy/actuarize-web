...
class CreateServerInputSet(InputSet):
        """
        Set the value of the AKIImage input for this choreography. ((optional, string) The URL to the AKI image.)
        """
        def set_AKIImage(self, value):
            InputSet._set_input(self, 'AKIImage', value)

        """
        Set the value of the ARIImage input for this choreography. ((optional, string) The URL to the ARI Image.)
        """
        ...
        """
        Set the value of the CloudID input for this choreography. ((optional, integer) The cloud region identifier. If undefined, the default is 1 (us-east).)
        """
        def set_CloudID(self, value):
            InputSet._set_input(self, 'CloudID', value)

        """
        Set the value of the EC2AvailabilityZone input for this choreography. ((optional, string) The  EC2 availablity zone, for example: us-east-1a, or any.  Do not set, if also passing the vpc_subnet_href parameter.)
        """
        def set_EC2AvailabilityZone(self, value):
            InputSet._set_input(self, 'EC2AvailabilityZone', value)

        """
        Set the value of the EC2Image input for this choreography. ((optional, string) The URL to AMI image.)
        """
        def set_EC2Image(self, value):
            InputSet._set_input(self, 'EC2Image', value)

        """
        Set the value of the EC2SSHKeyHref input for this choreography. ((optional, string) The URL to the SSH Key.)
        """
        def set_EC2SSHKeyHref(self, value):
            InputSet._set_input(self, 'EC2SSHKeyHref', value)

        """
        Set the value of the EC2SecurityGroupsHref input for this choreography. ((optional, string) The URL(s) to security group(s). Do not set, if also passing the vpc_subnet_href parameter.)
        """
        def set_EC2SecurityGroupsHref(self, value):
            InputSet._set_input(self, 'EC2SecurityGroupsHref', value)

        """
        Set the value of the InstanceType input for this choreography. ((optional, string) The AWS instance type: small, medium, etc.)
        """
        def set_InstanceType(self, value):
            InputSet._set_input(self, 'InstanceType', value)

        """
        Set the value of the MaxSpotPrice input for this choreography. ((optional, integer) The maximum price (a dollar value) dollars) per hour for the spot server.)
        """
        ...
        """
        Set the value of the Pricing input for this choreography. ((optional, string) AWS pricing.  Specify on_demand, or spot.)
        """
        def set_Pricing(self, value):
            InputSet._set_input(self, 'Pricing', value)

        """
        Set the value of the ServerDeployment input for this choreography. ((required, string) The URL of the deployment that this server wil be added to.)
        """
        def set_ServerDeployment(self, value):
            InputSet._set_input(self, 'ServerDeployment', value)

        """
        Set the value of the ServerNickname input for this choreography. ((required, string) The nickname for the server being created.)
        """
        def set_ServerNickname(self, value):
            InputSet._set_input(self, 'ServerNickname', value)

        """
        Set the value of the ServerTemplate input for this choreography. ((required, string) The URL to a server template.)
        """
        def set_ServerTemplate(self, value):
            InputSet._set_input(self, 'ServerTemplate', value)

        """
        Set the value of the Username input for this choreography. ((required, string) The username obtained from RightScale.)
        """
        def set_Username(self, value):
            InputSet._set_input(self, 'Username', value)

        """
        Set the value of the VPCSubnet input for this choreography. ((optional, string) The href to the VPC subnet.)
        """
