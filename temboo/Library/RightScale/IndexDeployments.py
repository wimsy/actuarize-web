...
class IndexDeploymentsInputSet(InputSet):
        ...
        """
        Set the value of the Filter input for this choreography. ((optional, string) An attributeName=AttributeValue filter pair. For example: nickname=mynick; OR description<>mydesc)
        """
