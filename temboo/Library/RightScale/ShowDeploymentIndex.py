...
class ShowDeploymentIndexInputSet(InputSet):
        ...
        """
        Set the value of the DeploymentID input for this choreography. ((required, integer) The DeploymentID to only list servers in this particular RightScale deployment.)
        """
        ...
        """
        Set the value of the ServerSettings input for this choreography. ((optional, string) Display additional information about this RightScale deployment. Set True to enable.)
        """
