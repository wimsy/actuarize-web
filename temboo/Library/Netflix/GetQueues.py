...
class GetQueues(Choreography):
    ...
    """
    Create a new instance of the GetQueues Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetQueues choreography.
