...
class CompanyParents(Choreography):
    ...
    """
    Create a new instance of the CompanyParents Choreography. A TembooSession object, containing a valid
...
class CompanyParentsInputSet(InputSet):
        ...
        """
        Set the value of the Year input for this choreography. ((optional, integer) If a year is specified, only parents for that year will be returned and the data in the company objects returned will be set appropriately for the request year. Defaults to most recent.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the CompanyParents choreography.
