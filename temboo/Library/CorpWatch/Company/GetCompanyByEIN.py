...
class GetCompanyByEIN(Choreography):
    ...
    """
    Create a new instance of the GetCompanyByEIN Choreography. A TembooSession object, containing a valid
...
class GetCompanyByEINInputSet(InputSet):
        ...
        """
        Set the value of the EIN input for this choreography. ((required, string) The IRS Employer Identification Number (tax ID) of a company.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetCompanyByEIN choreography.
