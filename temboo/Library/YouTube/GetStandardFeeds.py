...
class GetStandardFeedsInputSet(InputSet):
        ...
        """
        Set the value of the Type input for this choreography. ((required, string) Enter top_rated, top_favorites, most_viewed, most_shared, most_popular, most_recent, most_discussed, most_responded, recently_featured, or on_the_web.)
        """
