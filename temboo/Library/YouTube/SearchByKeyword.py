...
class SearchByKeywordInputSet(InputSet):
        ...
        """
        Set the value of the Keyword input for this choreography. ((required, string) A keyword associated with a  video, entered in all lowercase letters. Separate multiple keywords with commas (but no spaces).)
        """
