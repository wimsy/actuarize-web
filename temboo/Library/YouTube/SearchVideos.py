...
class SearchVideosInputSet(InputSet):
        ...
        """
        Set the value of the Query input for this choreography. ((required, string) A search query term, including title, keyword, description, author's username, or category. Enclose in quotation marks for an for an exact match.)
        """
