...
class SearchByCategoryInputSet(InputSet):
        ...
        """
        Set the value of the Category input for this choreography. ((required, string) A valid YouTube video category name, entered with the first letter capitalized.)
        """
