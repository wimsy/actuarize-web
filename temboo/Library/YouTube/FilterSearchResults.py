...
class FilterSearchResultsInputSet(InputSet):
        ...
        """
        Set the value of the FieldsToReturn input for this choreography. ((required, string) Specify the fields and conditions to return in the result set.)
        """
        ...
        """
        Set the value of the Query input for this choreography. ((required, string) A feed search query term, including title, keyword, description, authors' username, or category. Enclose in quotation marks for an exact match.)
        """
