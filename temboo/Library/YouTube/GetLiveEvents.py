...
class GetLiveEventsInputSet(InputSet):
        ...
        """
        Set the value of the Type input for this choreography. ((required, string) Specify the kind of live YouTube event list to retrieve: featured, live_now, upcoming, or recently_broadcasted.)
        """
