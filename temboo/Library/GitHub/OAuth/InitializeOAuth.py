...
class InitializeOAuth(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/GitHub/OAuth/InitializeOAuth')
...
class InitializeOAuthInputSet(InputSet):
        ...
        """
        Set the value of the Scope input for this choreography. ((optional, string) A comma separated list of scopes to associate with the access token.)
        """
