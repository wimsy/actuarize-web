...
class GetReadMe(Choreography):
    ...
    """
    Create a new instance of the GetReadMe Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetReadMe choreography.
