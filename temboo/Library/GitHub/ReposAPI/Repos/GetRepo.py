...
class GetRepo(Choreography):
    ...
    """
    Create a new instance of the GetRepo Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/GitHub/ReposAPI/Repos/GetRepo')
    ...
    def _make_result_set(self, result, path):
        return GetRepoResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return GetRepoChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the GetRepo
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class GetRepoInputSet(InputSet):
        """
        ...
        """
        Set the value of the Repo input for this choreography. ((required, string) The name of the repo to retrieve.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetRepo choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class GetRepoResultSet(ResultSet):
        """
...
class GetRepoChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return GetRepoResultSet(response, path)
