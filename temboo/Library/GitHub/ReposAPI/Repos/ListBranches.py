...
class ListBranches(Choreography):
    ...
    """
    Create a new instance of the ListBranches Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/GitHub/ReposAPI/Repos/ListBranches')
...
class ListBranchesInputSet(InputSet):
        ...
        """
        Set the value of the Repo input for this choreography. ((required, string) The name of the repo to list branches for.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the ListBranches choreography.
