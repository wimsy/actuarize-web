...
class RemoveCollaboratorInputSet(InputSet):
        ...
        """
        Set the value of the Collaborator input for this choreography. ((required, string) The username of the collaborator to remove.)
        """
        def set_Collaborator(self, value):
            InputSet._set_input(self, 'Collaborator', value)

        """
        Set the value of the Repo input for this choreography. ((required, string) The name of the repo that the collaborator will be removed from.)
        """
