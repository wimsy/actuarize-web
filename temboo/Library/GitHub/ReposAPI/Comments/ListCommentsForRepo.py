...
class ListCommentsForRepo(Choreography):
    ...
    """
    Create a new instance of the ListCommentsForRepo Choreography. A TembooSession object, containing a valid
...
class ListCommentsForRepoInputSet(InputSet):
        ...
        """
        Set the value of the Repo input for this choreography. ((required, string) The name of the repo to list comments for.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the ListCommentsForRepo choreography.
