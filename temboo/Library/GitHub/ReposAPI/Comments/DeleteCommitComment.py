...
class DeleteCommitComment(Choreography):
    ...
    """
    Create a new instance of the DeleteCommitComment Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the DeleteCommitComment choreography.
