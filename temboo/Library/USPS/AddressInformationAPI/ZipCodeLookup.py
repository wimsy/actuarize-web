...
class ZipCodeLookupInputSet(InputSet):
        ...
        """
        Set the value of the City input for this choreography. ((required, string) Maximum characters allowed: 15.)
        """
        ...
        """
        Set the value of the State input for this choreography. ((required, string) Maximum characters allowed: 2.)
        """
        def set_State(self, value):
            InputSet._set_input(self, 'State', value)

        """
        Set the value of the StreetAddress input for this choreography. ((required, string) Street address.  Maximum characters allowed: 38.)
        """
