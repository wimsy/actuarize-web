...
class ExpressMailServiceRequestInputSet(InputSet):
        """
        Set the value of the Date input for this choreography. ((required, date) Date the package is to be shipped. Must take the form 'MM/DD/YYYY'.)
        """
        def set_Date(self, value):
            InputSet._set_input(self, 'Date', value)

        """
        Set the value of the DestinationZip input for this choreography. ((required, integer) Five digit zip code.)
        """
        ...
        """
        Set the value of the OriginZip input for this choreography. ((required, integer) Three or five digit zip code.)
        """
