...
class PriorityMailServiceRequestInputSet(InputSet):
        ...
        """
        Set the value of the OriginZip input for this choreography. ((required, integer) First 3 digits of a 5-digit zip code)
        """
        ...
        """
        Set the value of the UserId input for this choreography. ((required, string) Alphanumeric ID assigned by USPS.  Required value.)
        """
