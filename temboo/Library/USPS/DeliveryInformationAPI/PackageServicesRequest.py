...
class PackageServicesRequestInputSet(InputSet):
        """
        Set the value of the Response input for this choreography. ((required, xml) The response from USPS Web Service)
        """
        def set_Response(self, value):
            InputSet._set_input(self, 'Response', value)

        """
        Set the value of the DestinationZip input for this choreography. ((required, integer) First 3 digits of a 5-digit zip code.)
        """
        ...
        """
        Set the value of the OriginZip input for this choreography. ((required, integer) First 3 digits of a 5-digit zip code.  Required value.)
        """
...
class PackageServicesRequestResultSet(ResultSet):
        """
        Retrieve the value for the "Response" output from this choreography execution. ((required, xml) The response from USPS Web Service)
        """
