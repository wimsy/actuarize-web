...
class DeleteScheduledDeliveryTime(Choreography):
    ...
    """
    Create a new instance of the DeleteScheduledDeliveryTime Choreography. A TembooSession object, containing a valid
...
class DeleteScheduledDeliveryTimeInputSet(InputSet):
        ...
        """
        Set the value of the Name input for this choreography. ((required, string) The name of the newsletter for which scheduled delievery will be removed.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the DeleteScheduledDeliveryTime choreography.
