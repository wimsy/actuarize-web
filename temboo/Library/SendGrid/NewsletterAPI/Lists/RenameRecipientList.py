...
class RenameRecipientListInputSet(InputSet):
        ...
        """
        Set the value of the List input for this choreography. ((required, string) The name of Recipient List that is to be renamed.)
        """
        def set_List(self, value):
            InputSet._set_input(self, 'List', value)

        """
        Set the value of the NewList input for this choreography. ((required, string) The new name of Recipient List that is to be renamed.)
        """
