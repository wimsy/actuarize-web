...
class GetAppSettings(Choreography):
    ...
    """
    Create a new instance of the GetAppSettings Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetAppSettings choreography.
