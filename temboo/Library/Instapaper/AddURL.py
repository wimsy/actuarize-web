...
class AddURLInputSet(InputSet):
        """
        Set the value of the Password input for this choreography. ((required, string) Your Instapaper password.)
        """
        ...
        """
        Set the value of the Username input for this choreography. ((required, string) Your Instapaper username.)
        """
