...
class ServiceAvailabilityRequestInputSet(InputSet):
        ...
        """
        Set the value of the DestinationCountryCode input for this choreography. ((required, string) The destination country code to use as an input to the service availability request)
        """
        def set_DestinationCountryCode(self, value):
            InputSet._set_input(self, 'DestinationCountryCode', value)

        """
        Set the value of the DestinationPostalCode input for this choreography. ((required, string) The destination postal code to use as an input to the service availability request)
        """
        ...
        """
        Set the value of the OriginCountryCode input for this choreography. ((required, string) The origin country code to use as an input to the service availability request)
        """
        def set_OriginCountryCode(self, value):
            InputSet._set_input(self, 'OriginCountryCode', value)

        """
        Set the value of the Password input for this choreography. ((required, password) The Production Password provided by FedEx Web Services)
        """
        def set_Password(self, value):
            InputSet._set_input(self, 'Password', value)

        """
        Set the value of the ShipDate input for this choreography. ((required, date) The date to use for the service availability request (epoch timestamp in milliseconds or formatted like yyyy-MM-dd))
        """
