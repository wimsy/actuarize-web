...
class GetAnalyticsByType(Choreography):
    ...
    """
    Create a new instance of the GetAnalyticsByType Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetAnalyticsByType choreography.
