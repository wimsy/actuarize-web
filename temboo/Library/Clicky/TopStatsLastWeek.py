...
class TopStatsLastWeek(Choreography):
    ...
    """
    Create a new instance of the TopStatsLastWeek Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the TopStatsLastWeek choreography.
