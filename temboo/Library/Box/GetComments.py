...
class GetComments(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Box/GetComments')
...
class GetCommentsInputSet(InputSet):
        ...
        """
        Set the value of the TargetID input for this choreography. ((required, string) The id of the file that you want to retrieve the comments for.)
        """
