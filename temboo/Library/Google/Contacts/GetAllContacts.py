...
class GetAllContactsInputSet(InputSet):
        ...
        """
        Set the value of the UserEmail input for this choreography. ((optional, string) The email address of the user whose contacts you want to retrieve. Defaults to "default," or the user whose OAuth access token is passed.)
        """
