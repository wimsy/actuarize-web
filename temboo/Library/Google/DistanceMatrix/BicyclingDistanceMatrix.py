...
class BicyclingDistanceMatrix(Choreography):
    ...
    """
    Create a new instance of the BicyclingDistanceMatrix Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/DistanceMatrix/BicyclingDistanceMatrix')
    ...
    def _make_result_set(self, result, path):
        return BicyclingDistanceMatrixResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return BicyclingDistanceMatrixChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the BicyclingDistanceMatrix
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class BicyclingDistanceMatrixInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the BicyclingDistanceMatrix choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class BicyclingDistanceMatrixResultSet(ResultSet):
        """
...
class BicyclingDistanceMatrixChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return BicyclingDistanceMatrixResultSet(response, path)
