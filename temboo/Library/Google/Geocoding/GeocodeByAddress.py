...
class GeocodeByAddressInputSet(InputSet):
        """
        Set the value of the Address input for this choreography. ((required, string) The address that you want to geocode.)
        """
...
class GeocodeByAddressResultSet(ResultSet):
        """
        Retrieve the value for the "Latitude" output from this choreography execution. ((decimal) The latitude coordinate associated with the address provided.)
        """
        def get_Latitude(self):
            return self._output.get('Latitude', None)
        """
        Retrieve the value for the "Longitude" output from this choreography execution. ((decimal) The longitude coordinate associated with the address provided.)
        """
