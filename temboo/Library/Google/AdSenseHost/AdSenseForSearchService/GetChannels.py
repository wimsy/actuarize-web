...
class GetChannels(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/AdSenseHost/AdSenseForSearchService/GetChannels')
...
class GetChannelsInputSet(InputSet):
        """
        Set the value of the ChannelService_Type input for this choreography. ((required, string) Must be set to 'Custom'.)
        """
        def set_ChannelService_Type(self, value):
            InputSet._set_input(self, 'ChannelService_Type', value)

        """
        Set the value of the ClientID input for this choreography. ((required, string) The ID of the publisher to get the channels of.)
        """
