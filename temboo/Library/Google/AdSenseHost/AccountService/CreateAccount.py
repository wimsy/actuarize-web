...
class CreateAccountInputSet(InputSet):
        """
        Set the value of the AddContentAds input for this choreography. ((required, boolean) Pass in '1' to add ContentAds syndication service, '0' to omit.)
        """
        def set_AddContentAds(self, value):
            InputSet._set_input(self, 'AddContentAds', value)

        """
        Set the value of the AddSearchAds input for this choreography. ((required, boolean) Pass in '1' to add SearchAds syndication service, '0' to omit.)
        """
        def set_AddSearchAds(self, value):
            InputSet._set_input(self, 'AddSearchAds', value)

        """
        Set the value of the DeveloperURL input for this choreography. ((required, string) The site to be associated with this publisher.)
        """
        def set_DeveloperURL(self, value):
            InputSet._set_input(self, 'DeveloperURL', value)

        """
        Set the value of the EmailPromotionsPreferences input for this choreography. ((required, boolean) Email promotions preferences for the new account. Pass in '1' to enable and '0' to disable.)
        """
        ...
        """
        Set the value of the EntityType input for this choreography. ((required, string) One of 'Individual' or 'Business'.)
        """
        def set_EntityType(self, value):
            InputSet._set_input(self, 'EntityType', value)

        """
        Set the value of the LoginEmail input for this choreography. ((required, string) The login email for the new account)
        """
