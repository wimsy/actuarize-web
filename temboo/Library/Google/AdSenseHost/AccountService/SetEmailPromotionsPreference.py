...
class SetEmailPromotionsPreferenceInputSet(InputSet):
        """
        Set the value of the ClientID input for this choreography. ((required, string) The ID of the publisher for whom the email promotions preference will be set.)
        """
        ...
        """
        Set the value of the EnableEmailPromotions input for this choreography. ((required, boolean) Pass in '1' (enabled) or '0' (disabled).)
        """
