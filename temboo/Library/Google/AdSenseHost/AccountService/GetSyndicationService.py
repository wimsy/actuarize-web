...
class GetSyndicationServiceInputSet(InputSet):
        """
        Set the value of the ClientID input for this choreography. ((required, string) The ID of the publisher to get the syndication service data from.)
        """
        ...
        """
        Set the value of the SynServiceType input for this choreography. ((required, string) One of 'ContentAds' or 'SearchAds'.)
        """
