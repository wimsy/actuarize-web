...
class AssociateAccountInputSet(InputSet):
        ...
        """
        Set the value of the Phone input for this choreography. ((required, integer) The last five digits of the publisher's phone number, in the form '99999'.)
        """
        def set_Phone(self, value):
            InputSet._set_input(self, 'Phone', value)

        """
        Set the value of the PostalCode input for this choreography. ((required, integer) The publisher's 5-digit postal code.)
        """
        def set_PostalCode(self, value):
            InputSet._set_input(self, 'PostalCode', value)

        """
        Set the value of the PublisherEmail input for this choreography. ((required, string) The publisher's email address.)
        """
