...
class ResendVerificationEmailInputSet(InputSet):
        """
        Set the value of the ClientID input for this choreography. ((required, string) The ID of the publisher to send a verification email to.)
        """
        def set_ClientID(self, value):
            InputSet._set_input(self, 'ClientID', value)

        """
        Set the value of the DeveloperURL input for this choreography. ((required, string) The developer site URL.)
        """
