...
class GetInactiveChannelsInputSet(InputSet):
        """
        Set the value of the ChannelServiceType input for this choreography. ((required, string) One of 'Url' or 'Custom'.)
        """
        def set_ChannelServiceType(self, value):
            InputSet._set_input(self, 'ChannelServiceType', value)

        """
        Set the value of the ClientID input for this choreography. ((required, string) The ID of the publisher to get the inactive channels of.)
        """
