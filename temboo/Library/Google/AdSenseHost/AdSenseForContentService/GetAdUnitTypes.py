...
class GetAdUnitTypesInputSet(InputSet):
        """
        Set the value of the AdLayout input for this choreography. ((required, string) The type of ad layout desired. Values are width x height in pixels, e.g. '728x90'.)
        """
        def set_AdLayout(self, value):
            InputSet._set_input(self, 'AdLayout', value)

        """
        Set the value of the ClientID input for this choreography. ((required, string) The ID of the publisher to get the ad unit types of.)
        """
