...
class GetDrivingDirections(Choreography):
    ...
    """
    Create a new instance of the GetDrivingDirections Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetDrivingDirections choreography.
