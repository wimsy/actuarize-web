...
class SearchInputSet(InputSet):
        ...
        """
        Set the value of the OrderBy input for this choreography. ((optional, string) Specifies how to order search results. Valid values are: "best" (Sort activities by relevance to the user) or "recent" (Sort activities by published date). Default is "recent".)
        """
        ...
        """
        Set the value of the Query input for this choreography. ((required, string) Full-text search query string.)
        """
