...
class Get(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Plus/People/Get')
...
class GetInputSet(InputSet):
        ...
        """
        Set the value of the UserID input for this choreography. ((optional, string) The ID of the person to get the profile for. The value "me" is set as the default to indicate the authenticated user.)
        """
