...
class Insert(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Replies/Insert')
...
class InsertInputSet(InputSet):
        """
        Set the value of the RequestBody input for this choreography. ((required, json) A JSON representation of fields in a reply resource. The JSON string must contain a key for content or verb. See documentation for formatting examples.)
        """
