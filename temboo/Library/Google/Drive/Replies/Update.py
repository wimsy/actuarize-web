...
class Update(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Replies/Update')
...
class UpdateInputSet(InputSet):
        """
        Set the value of the RequestBody input for this choreography. ((required, json) A JSON representation of fields in a reply resource. The JSON string must contain a key for content. See documentation for formatting examples.)
        """
