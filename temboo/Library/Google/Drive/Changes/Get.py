...
class Get(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Changes/Get')
...
class GetInputSet(InputSet):
        ...
        """
        Set the value of the ChangeID input for this choreography. ((required, string) The ID of the change.)
        """
        def set_ChangeID(self, value):
            InputSet._set_input(self, 'ChangeID', value)
