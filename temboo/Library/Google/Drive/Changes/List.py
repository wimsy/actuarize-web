...
class List(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Changes/List')
...
class ListInputSet(InputSet):
        ...
        """
        Set the value of the IncludeDeleted input for this choreography. ((optional, boolean) Whether to include deleted items. (Default: true).)
        """
        def set_IncludeDeleted(self, value):
            InputSet._set_input(self, 'IncludeDeleted', value)

        """
        Set the value of the IncludeSubscribed input for this choreography. ((optional, boolean) Whether to include shared files and public files the user opened. If false, the list includes owned files plus any shared or public files the user explictly added to a folder in Drive. (Default: true))
        """
        def set_IncludeSubscribed(self, value):
            InputSet._set_input(self, 'IncludeSubscribed', value)

        """
        Set the value of the MaxResults input for this choreography. ((optional, boolean) Maximum number of changes to return.)
        """
        def set_MaxResults(self, value):
            InputSet._set_input(self, 'MaxResults', value)

        """
        Set the value of the PageToken input for this choreography. ((optional, string) Page token for changes.)
        """
        ...
        """
        Set the value of the StartChangeID input for this choreography. ((optional, multiline) Change ID to start listing changes from.)
        """
        def set_StartChangeID(self, value):
            InputSet._set_input(self, 'StartChangeID', value)
