...
class Insert(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Permissions/Insert')
...
class InsertInputSet(InputSet):
        """
        Set the value of the RequestBody input for this choreography. ((required, json) A JSON representation of fields in a permissions resource. The JSON string must contain keys for role, type, and value. See documentation for formatting examples.)
        """
        ...
        """
        Set the value of the SendNotificationEmails input for this choreography. ((optional, boolean) Whether to send notification emails. (Default: true).)
        """
        def set_SendNotificationEmails(self, value):
            InputSet._set_input(self, 'SendNotificationEmails', value)
