...
class UpdateInputSet(InputSet):
        """
        Set the value of the RequestBody input for this choreography. ((required, json) A JSON representation of fields in a permissions resource. The JSON string can contain keys for role and additionalRoles. See documentation for formatting examples.)
        """
        ...
        """
        Set the value of the PermissionID input for this choreography. ((required, string) The ID for the permission.)
        """
