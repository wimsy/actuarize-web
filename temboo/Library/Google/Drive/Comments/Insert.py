...
class Insert(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Comments/Insert')
...
class InsertInputSet(InputSet):
        """
        Set the value of the RequestBody input for this choreography. ((required, json) A JSON representation of fields in a comment resource which shoud contain at least one key for content. See documentation for formatting examples.)
        """
