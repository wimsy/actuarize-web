...
class Insert(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Children/Insert')
...
class InsertInputSet(InputSet):
        ...
        """
        Set the value of the ID input for this choreography. ((optional, string) The ID of the child.)
        """
