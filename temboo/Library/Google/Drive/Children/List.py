...
class List(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Children/List')
...
class ListInputSet(InputSet):
        ...
        """
        Set the value of the FolderID input for this choreography. ((required, string) The ID of the folder. To list all files in the root folder, specify the value "root".)
        """
        def set_FolderID(self, value):
            InputSet._set_input(self, 'FolderID', value)

        """
        Set the value of the MaxResults input for this choreography. ((optional, integer) Maximum number of children to return.)
        """
        def set_MaxResults(self, value):
            InputSet._set_input(self, 'MaxResults', value)

        """
        Set the value of the PageToken input for this choreography. ((optional, string) Page token for children.)
        """
        def set_PageToken(self, value):
            InputSet._set_input(self, 'PageToken', value)

        """
        Set the value of the Query input for this choreography. ((optional, string) Query string for searching children.)
        """
