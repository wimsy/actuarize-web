...
class Untrash(Choreography):
    ...
    """
    Create a new instance of the Untrash Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Files/Untrash')
...
class UntrashInputSet(InputSet):
        ...
        """
        Set the value of the FileID input for this choreography. ((required, string) The ID of the file to untrash.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the Untrash choreography.
