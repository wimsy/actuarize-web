...
class Trash(Choreography):
    ...
    """
    Create a new instance of the Trash Choreography. A TembooSession object, containing a valid
...
class TrashInputSet(InputSet):
        ...
        """
        Set the value of the FileID input for this choreography. ((required, string) The ID of the file to trash.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the Trash choreography.
