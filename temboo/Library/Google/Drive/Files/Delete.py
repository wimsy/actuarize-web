...
class Delete(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Files/Delete')
...
class DeleteInputSet(InputSet):
        ...
        """
        Set the value of the FileID input for this choreography. ((required, string) The ID of the file to delete.)
        """
