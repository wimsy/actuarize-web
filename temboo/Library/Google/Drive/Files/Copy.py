...
class Copy(Choreography):
    ...
    """
    Create a new instance of the Copy Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Drive/Files/Copy')
...
class CopyInputSet(InputSet):
        """
        Set the value of the RequestBody input for this choreography. ((optional, json) A JSON representation of fields in a file resource. File metadata information (such as the title) can be set using this input. See documentation for formatting examples.)
        """
        ...
        """
        Set the value of the FileID input for this choreography. ((required, string) The ID of the file to copy.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the Copy choreography.
