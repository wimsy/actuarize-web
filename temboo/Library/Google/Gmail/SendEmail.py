...
class SendEmailInputSet(InputSet):
        ...
        """
        Set the value of the Password input for this choreography. ((required, password) Your Gmail password.)
        """
        ...
        """
        Set the value of the Username input for this choreography. ((required, string) Your Gmail email address. Note, this will used to authenticate your account and as the From Address for the email you are sending.)
        """
