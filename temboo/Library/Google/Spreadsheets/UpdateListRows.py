...
class UpdateListRowsInputSet(InputSet):
        """
        Set the value of the RowsetXML input for this choreography. ((required, xml) The row of data that you want to update in XML format. Your XML needs to be in the rowset/row schema described in the Choreo documentation.)
        """
        ...
        """
        Set the value of the RowId input for this choreography. ((required, string) The unique id of the row you want to update)
        """
        def set_RowId(self, value):
            InputSet._set_input(self, 'RowId', value)

        """
        Set the value of the SpreadsheetKey input for this choreography. ((required, string) The unique key of the spreadsheet that contains the worksheet you want to update)
        """
        ...
        """
        Set the value of the WorksheetId input for this choreography. ((required, string) The unique id of the worksheet that you want to update)
        """
