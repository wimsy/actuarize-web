...
class AddWorksheetInputSet(InputSet):
        """
        Set the value of the ColumnCount input for this choreography. ((required, integer) The number of columns that you want to specify for the new worksheet)
        """
        ...
        """
        Set the value of the RowCount input for this choreography. ((required, integer) The number of rows that you want to specify for the new worksheet)
        """
        def set_RowCount(self, value):
            InputSet._set_input(self, 'RowCount', value)

        """
        Set the value of the SpreadsheetKey input for this choreography. ((required, string) The unique key associated with the spreadsheet that you want to add a worksheet to)
        """
