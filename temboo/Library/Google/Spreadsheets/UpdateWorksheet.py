...
class UpdateWorksheetInputSet(InputSet):
        """
        Set the value of the ColumnCount input for this choreography. ((required, integer) The number of columns that you want to specify for the worksheet)
        """
        ...
        """
        Set the value of the RowCount input for this choreography. ((required, integer) The number of rows that you want to specify for the worksheet)
        """
        def set_RowCount(self, value):
            InputSet._set_input(self, 'RowCount', value)

        """
        Set the value of the SpreadsheetKey input for this choreography. ((required, string) The unique key associated with the spreadsheet that contains a worksheet you want to update)
        """
        def set_SpreadsheetKey(self, value):
            InputSet._set_input(self, 'SpreadsheetKey', value)

        """
        Set the value of the Title input for this choreography. ((required, string) The new title of the worksheet)
        """
        ...
        """
        Set the value of the WorksheetId input for this choreography. ((required, string) The unique id associated with the worksheet that you want to update)
        """
