...
class DeleteListRowInputSet(InputSet):
        """
        Set the value of the EditLink input for this choreography. ((conditional, string) The entry's edit link URL. Can be retrieved by running RetrieveListFeed and parsing the 'edit' link returned. When the edit link is provided, SpreadsheetKey, WorksheetId, and RowId are not needed.)
        """
