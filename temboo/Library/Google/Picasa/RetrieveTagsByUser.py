...
class RetrieveTagsByUser(Choreography):
    ...
    """
    Create a new instance of the RetrieveTagsByUser Choreography. A TembooSession object, containing a valid
    set of Temboo credentials, must be supplied.
    """
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/Google/Picasa/RetrieveTagsByUser')
    ...
    def _make_result_set(self, result, path):
        return RetrieveTagsByUserResultSet(result, path)

    def _make_execution(self, session, exec_id, path):
        return RetrieveTagsByUserChoreographyExecution(session, exec_id, path)

"""
An InputSet with methods appropriate for specifying the inputs to the RetrieveTagsByUser
choreography. The InputSet object is used to specify input parameters when executing this choreo.
"""
class RetrieveTagsByUserInputSet(InputSet):
        """
...
"""
A ResultSet with methods tailored to the values returned by the RetrieveTagsByUser choreography.
The ResultSet object is used to retrieve the results of a choreography execution.
"""
class RetrieveTagsByUserResultSet(ResultSet):
        """
...
class RetrieveTagsByUserChoreographyExecution(ChoreographyExecution):
    
    def _make_result_set(self, response, path):
        return RetrieveTagsByUserResultSet(response, path)
