...
class DeleteAlbum(Choreography):
    ...
    """
    Create a new instance of the DeleteAlbum Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the DeleteAlbum choreography.
