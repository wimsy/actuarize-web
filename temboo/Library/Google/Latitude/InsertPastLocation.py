...
class InsertPastLocationInputSet(InputSet):
        ...
        """
        Set the value of the Latitide input for this choreography. ((required, decimal) Enter latitude coordinates. For example: 37.420352.)
        """
        def set_Latitide(self, value):
            InputSet._set_input(self, 'Latitide', value)

        """
        Set the value of the Longitude input for this choreography. ((required, decimal) Enter longitude coordinates.  For example: -122.083389.)
        """
        ...
        """
        Set the value of the TimestampMs input for this choreography. ((required, date) Enter a timestamp value (in epoch time).  Example: 1325715558.)
        """
