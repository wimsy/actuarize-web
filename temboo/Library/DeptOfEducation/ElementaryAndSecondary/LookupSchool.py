...
class LookupSchool(Choreography):
    ...
    def __init__(self, temboo_session):
        Choreography.__init__(self, temboo_session, '/Library/DeptOfEducation/ElementaryAndSecondary/LookupSchool')
...
class LookupSchoolInputSet(InputSet):
        """
        Set the value of the Keyword input for this choreography. ((required, string) Used to perform a full text search on the data set. For example, you can search for a school name or a school's unique ID.)
        """
