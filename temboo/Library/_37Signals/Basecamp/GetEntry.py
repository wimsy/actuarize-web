...
class GetEntryInputSet(InputSet):
        ...
        """
        Set the value of the EntryID input for this choreography. ((required, integer) The ID for the calendar entry to retrieve.)
        """
        ...
        """
        Set the value of the ProjectID input for this choreography. ((required, integer) The ID for the project from which to retrieve the calendar entry.)
        """
