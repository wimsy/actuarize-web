...
class DeleteEntryInputSet(InputSet):
        ...
        """
        Set the value of the EntryID input for this choreography. ((required, integer) The ID for the calendar entry to delete.)
        """
        ...
        """
        Set the value of the ProjectID input for this choreography. ((required, integer) The ID for the project from which to delete the calendar entry.)
        """
