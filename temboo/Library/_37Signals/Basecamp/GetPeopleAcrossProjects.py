...
class GetPeopleAcrossProjects(Choreography):
    ...
    """
    Create a new instance of the GetPeopleAcrossProjects Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetPeopleAcrossProjects choreography.
