...
class UpdateItemInputSet(InputSet):
        ...
        """
        Set the value of the Content input for this choreography. ((required, string) The text of the updated item.)
        """
        def set_Content(self, value):
            InputSet._set_input(self, 'Content', value)

        """
        Set the value of the ItemID input for this choreography. ((required, integer) The ID for the item to update.)
        """
