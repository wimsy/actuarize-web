...
class GetAllMilestones(Choreography):
    ...
    """
    Create a new instance of the GetAllMilestones Choreography. A TembooSession object, containing a valid
...
class GetAllMilestonesInputSet(InputSet):
        ...
        """
        Set the value of the Password input for this choreography. ((required, password) The Basecamp account password. Use the value 'X' when specifying an API Key for the Username input.)
        """
        def set_Password(self, value):
            InputSet._set_input(self, 'Password', value)

        """
        Set the value of the ProjectID input for this choreography. ((required, integer) The ID for the project from which to retrieve all milestones.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the GetAllMilestones choreography.
