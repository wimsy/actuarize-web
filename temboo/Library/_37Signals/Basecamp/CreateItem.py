...
class CreateItemInputSet(InputSet):
        ...
        """
        Set the value of the Content input for this choreography. ((required, string) The text of the item to create.)
        """
        def set_Content(self, value):
            InputSet._set_input(self, 'Content', value)

        """
        Set the value of the ListID input for this choreography. ((required, integer) The ID for the list in which to create the new item.)
        """
