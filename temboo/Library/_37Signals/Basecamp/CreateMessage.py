...
class CreateMessageInputSet(InputSet):
        ...
        """
        Set the value of the Body input for this choreography. ((required, string) The body of the message you're creating.)
        """
        ...
        """
        Set the value of the ProjectId input for this choreography. ((required, integer) The ID of the project that the message will be created under.)
        """
        def set_ProjectId(self, value):
            InputSet._set_input(self, 'ProjectId', value)

        """
        Set the value of the Title input for this choreography. ((required, string) The title of the message you'e creating.)
        """
