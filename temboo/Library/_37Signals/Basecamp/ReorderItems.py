...
class ReorderItemsInputSet(InputSet):
        ...
        """
        Set the value of the FirstItemID input for this choreography. ((required, integer) The ID number for the first item in the list.)
        """
        def set_FirstItemID(self, value):
            InputSet._set_input(self, 'FirstItemID', value)

        """
        Set the value of the ListID input for this choreography. ((required, integer) The ID for the To-do list the items of which you're reordering.)
        """
