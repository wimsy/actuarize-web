...
class GetProjects(Choreography):
    ...
    """
    Create a new instance of the GetProjects Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetProjects choreography.
