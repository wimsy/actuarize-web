...
class ReorderListsInputSet(InputSet):
        ...
        """
        Set the value of the FirstListID input for this choreography. ((required, integer) The ID number for the project's first To-Do list.)
        """
        ...
        """
        Set the value of the ProjectID input for this choreography. ((required, integer) The ID for the project associated with the to-do lists that you are reordering.)
        """
