...
class GetReferringDomains(Choreography):
    ...
    """
    Create a new instance of the GetReferringDomains Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the GetReferringDomains choreography.
