...
class UpdateAccount(Choreography):
    ...
    """
    Create a new instance of the UpdateAccount Choreography. A TembooSession object, containing a valid
...
class UpdateAccountInputSet(InputSet):
        ...
        """
        Set the value of the ID input for this choreography. ((required, integer) The id of the account to update.)
        """
...
"""
A ResultSet with methods tailored to the values returned by the UpdateAccount choreography.
