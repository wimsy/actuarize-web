...
class ContributorTypeBreakdown(Choreography):
    ...
    """
    Create a new instance of the ContributorTypeBreakdown Choreography. A TembooSession object, containing a valid
...
"""
A ResultSet with methods tailored to the values returned by the ContributorTypeBreakdown choreography.
