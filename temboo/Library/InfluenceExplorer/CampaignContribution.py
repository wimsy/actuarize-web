...
class CampaignContributionInputSet(InputSet):
        ...
        """
        Set the value of the Amount input for this choreography. ((conditional, string) Enter the amount of dollars spent on lobbying.  Valid formats include: 500 (exactly $500); >|500 (greater than, or equal to 500); <|500 (less than or equal to 500).)
        """
        def set_Amount(self, value):
            InputSet._set_input(self, 'Amount', value)

        """
        Set the value of the ContributorName input for this choreography. ((conditional, string) Specfiy the name of an individual, PAC, organization, or employer for which a full-text search will be performed.)
        """
        def set_ContributorName(self, value):
            InputSet._set_input(self, 'ContributorName', value)

        """
        Set the value of the ContributorsByState input for this choreography. ((conditional, string) Enter a two-letter state designation from which the contribution is made.)
        """
        def set_ContributorsByState(self, value):
            InputSet._set_input(self, 'ContributorsByState', value)

        """
        Set the value of the Cycle input for this choreography. ((conditional, string) Specify a yyyy-formatted election cycle. Example: 2012, or 2008|2012 to limit results between 2008 and 2012.)
        """
        def set_Cycle(self, value):
            InputSet._set_input(self, 'Cycle', value)

        """
        Set the value of the Date input for this choreography. ((conditional, string) Specify a date of the contribution in ISO date format.  For example: 2006-08-06.  Or, ><|2006-08-06|2006-09-12 to limit results between specific dates.)
        """
        def set_Date(self, value):
            InputSet._set_input(self, 'Date', value)

        """
        Set the value of the OrganizationName input for this choreography. ((conditional, string) Specify a full-text search on employer, organization, and parent organization.)
        """
        def set_OrganizationName(self, value):
            InputSet._set_input(self, 'OrganizationName', value)

        """
        Set the value of the RecipientName input for this choreography. ((conditional, string) Enter the full-text search on name of PAC or candidate receiving the contribution.)
        """
        def set_RecipientName(self, value):
            InputSet._set_input(self, 'RecipientName', value)

        """
        Set the value of the RecipientState input for this choreography. ((conditional, string) Specify a two-letter state abbreviation for the state in which the recipient of contributions is running a campaign.)
        """
        ...
        """
        Set the value of the Seat input for this choreography. ((conditional, string) Specify the type of political office being sought.  Examples: federal:senate (US Senate), federal:president (US President), state:governor.  For more info see documentation.)
        """
